...
class YearController extends Controller
{
    ...
    public function postUpdate($id)
    {
        ...
        $year->YearNameBangla = Input::get('YearNameBangla');
        $year->save();
    ...
    public function postCreate()
    {
        $validator = Validator::make(Input::all(), [
            ...
            "YearNameBangla" => "required|unique:years",
        ]);
        if ($validator->fails()) {
            return array(
                'fail' => true,
        ...
        $year = new Year();
//        $year->file('image')->move($destinationPath, $fileName);
