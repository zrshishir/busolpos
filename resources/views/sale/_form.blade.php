<div class="col-md-12">
    ...
    <div class="form-group required col-md-6" id="form-price-error">
        {!! Form::label("price","Price",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::text("price",null,["class"=>"form-control required","id"=>"price"]) !!}
            <span id="price-error" class="help-block"></span>
        </div>
    </div>
    <div class="form-group required col-md-6" id="form-profit-error">
        {!! Form::label("profit","Sell Price",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::text("profit",null,["class"=>"form-control required","id"=>"profit"]) !!}
            <span id="profit-error" class="help-block"></span>
        </div>
    </div>
    </div>
...
<div class="form-group">
    <div class="col-md-6 col-md-push-3">
        <a href="javascript:ajaxLoad('sale/list')" class="btn btn-danger"><i
