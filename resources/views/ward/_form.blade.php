<div class="col-md-12">
    <div class="form-group required col-md-6" id="form-DivisionId-error">
        {!! Form::label("DivisionId","Division Name",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
    ...
    <div class="form-group required col-md-6" id="form-DistrictId-error">
        {!! Form::label("DistrictId","District Name",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
    ...
    <div class="form-group required col-md-6" id="form-UnionId-error">
        {!! Form::label("UnionId","Union",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
    ...
    <div class="form-group required col-md-6" id="form-WardName-error">
        {!! Form::label("WardName","Ward No",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
